...
This chart is the Kubernetes and cloud observability data plane for Kova. It is
installed as an independent release and does not own or restart Kova BuildKit
workers.
