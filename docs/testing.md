...
| `make e2e-helm-quickstart` | Packages the chart, installs it into a minimal kind cluster, and runs the CLI build flow against the packaged chart. | Helm archive, `examples/simple`, `.work/result.jsonl` |
